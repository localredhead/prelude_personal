...
(custom-set-faces
 ...
 '(highlight-indentation-current-column-face ((t (:background "color-239"))))
 '(highlight-indentation-face ((t (:background "color-239"))))
 '(hl-line ((t (:stipple nil :background "color-239"))))
 ...
 '(tabbar-default ((t (:inherit variable-pitch :background "#DCDCCC" :foreground "#8FB28F" :height 0.8))))
